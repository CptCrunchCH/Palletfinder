...
if __name__ == '__main__':
    ...
    lb = joblib.load('home/Palletfinder/05_Make_Prediction/output/lb.pkl')

    model = model()
    model.load_state_dict(torch.load('home/Palletfinder/05_Make_Prediction/output/model.pth'))

    path = 'home/Palletfinder/05_Make_Prediction/Images/frame_left.png'
